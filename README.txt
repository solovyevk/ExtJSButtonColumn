Recently I had a task to execute number of actions from the grid. I couldn't use Ext.grid.column.Action because I had not just a
few but many actions, the actions set is unique for each record and user want to select them from drop down. My first
